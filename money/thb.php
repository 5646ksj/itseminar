...
for($i=0;$i<13;$i++){
	$wr_find=strpos($wr_bankar[$i][0],"태국");
	$sh_find=strpos($sh_bankar[$i][0],"태국");
	$nh_find=strpos($nh_bankar[$i][0],"태국");
	$ibk_find=strpos($ibk_bankar[$i][0],"태국");
	$st_ch_find=strpos($st_ch_bankar[$i][0],"태국");
//	$citi_find=strpos($citi_bankar[$i][0],"홍콩");
	$shyup_find=strpos($shyup_bankar[$i][0],"태국");
	$dg_find=strpos($dg_bankar[$i][0],"태국");
	$jb_find=strpos($jb_bankar[$i][0],"태국");
	$jj_find=strpos($jj_bankar[$i][0],"태국");
