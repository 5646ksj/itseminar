...
for($i=0;$i<22;$i++){
	$wr_find=strpos($wr_bankar[$i][0],"필리핀");
	$sh_find=strpos($sh_bankar[$i][0],"필리핀");
	$nh_find=strpos($nh_bankar[$i][0],"필리핀");
	$ibk_find=strpos($ibk_bankar[$i][0],"필리핀");
//	$st_ch_find=strpos($st_ch_bankar[$i][0],"태국");
//	$citi_find=strpos($citi_bankar[$i][0],"홍콩");
	$shyup_find=strpos($shyup_bankar[$i][0],"필리핀");
	$dg_find=strpos($dg_bankar[$i][0],"필리핀");
	$jb_find=strpos($jb_bankar[$i][0],"필리핀");
	$jj_find=strpos($jj_bankar[$i][0],"필리핀");
