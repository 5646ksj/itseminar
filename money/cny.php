...
for($i=0;$i<3;$i++){
	$wr_find=strpos($wr_bankar[$i][0],"중국");
	$sh_find=strpos($sh_bankar[$i][0],"중국");
	$nh_find=strpos($nh_bankar[$i][0],"중국");
	$ibk_find=strpos($ibk_bankar[$i][0],"중국");
	$st_ch_find=strpos($st_ch_bankar[$i][0],"중국");
	$citi_find=strpos($citi_bankar[$i][0],"중국");
	$shyup_find=strpos($shyup_bankar[$i][0],"중국");
	$dg_find=strpos($dg_bankar[$i][0],"중국");
	$jb_find=strpos($jb_bankar[$i][0],"중국");
	$jj_find=strpos($jj_bankar[$i][0],"중국");
