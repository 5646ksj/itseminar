...
for($i=0;$i<8;$i++){
        $citi_find=strpos($citi_bankar[$i][0],"캐나다");
        if($citi_find!==false){
...
for($i=0;$i<21;$i++){
	$wr_find=strpos($wr_bankar[$i][0],"캐나다");
	$sh_find=strpos($sh_bankar[$i][0],"캐나다");
	$nh_find=strpos($nh_bankar[$i][0],"캐나다");
	$ibk_find=strpos($ibk_bankar[$i][0],"캐나다");
	$st_ch_find=strpos($st_ch_bankar[$i][0],"캐나다");
	$shyup_find=strpos($shyup_bankar[$i][0],"캐나다");
	$dg_find=strpos($dg_bankar[$i][0],"캐나다");
	$jb_find=strpos($jb_bankar[$i][0],"캐나다");
	$jj_find=strpos($jj_bankar[$i][0],"캐나다");
