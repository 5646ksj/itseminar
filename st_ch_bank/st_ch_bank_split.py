...
import requests
s=requests.Session()
req=s.get('https://www.mibank.me/exchange/bank/index.php?search_code=023')
#ireq.encoding='euc-kr'
html=req.text
f=open('st_ch_bank_list.py','w')
html=req.text
        #big frame
...
gps=[[0 for cols in range(8)]for rows in range(21)]
for i in range(0,21):
