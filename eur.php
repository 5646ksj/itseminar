...
for($i=0;$i<13;$i++){
	$wr_find=strpos($wr_bankar[$i][0],"유럽연합");
	$sh_find=strpos($sh_bankar[$i][0],"유럽연합");
	$nh_find=strpos($nh_bankar[$i][0],"유럽연합");
	$ibk_find=strpos($ibk_bankar[$i][0],"유럽연합");
	$st_ch_find=strpos($st_ch_bankar[$i][0],"유럽연합");
	$citi_find=strpos($citi_bankar[$i][0],"유럽연합");
	$shyup_find=strpos($shyup_bankar[$i][0],"유럽연합");
	$dg_find=strpos($dg_bankar[$i][0],"유럽연합");
	$jb_find=strpos($jb_bankar[$i][0],"유럽연합");
	$kn_find=strpos($kn_bankar[$i][0],"유럽연합");
	$jj_find=strpos($jj_bankar[$i][0],"유럽연합");
